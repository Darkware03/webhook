...
router.post('/v1/2fa/verificar', Call(ApiController.verifyTwoFactorAuthCode));
router.post('/v1/2fa/codigo', Call(ApiController.sendCode));
router.get('/v1/verificacion/usuario/:token', Call(ApiController.confirmUser));
